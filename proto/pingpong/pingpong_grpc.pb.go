...
func (c *pingPongServiceClient) Pingpong(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, "/proto.pingpong.PingPongService/Pingpong", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PingPongService_Pingpong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.pingpong.PingPongService/Pingpong",
	}
...
var PingPongService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.pingpong.PingPongService",
